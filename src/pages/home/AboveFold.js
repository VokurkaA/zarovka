...
function AboveFold() {
    ...
    return (
        <div id='image' className='relative select-none'>
            <img className='w-full h-[80svh] object-cover bg-[#a8b0bb]' src={bigImg} alt="Main content" />
            <div className='absolute grid grid-cols-2 inset-0 text-background opacity-85 content-center px-2 2xs:px-8 md:px-24'>
